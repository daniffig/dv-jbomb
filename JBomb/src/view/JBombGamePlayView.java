	...
	public void update(Observable arg0, Object event) {
		...
		switch(g){
			case BOMB_OWNER_CHANGED:
				System.out.println("[Server-GamePlayView] Me notificaron que el due�o de la bomba cambi�");
				vv.repaint();
				break;
			case BOMB_EXPLODED:
				...
				break;
			case BOMB_SETTED:
				System.out.println("[Server-GamePlayView] Se seteo la bomba eso quiere decir que empezó una nueva ronda");
